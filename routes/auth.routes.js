...
router.post('/register',
    ...
    async (req, res) => {
        ...
        try {
            ...
            res.json({ token, name: user.name, email: user.email, userId: user.id, telephone: user.telephone, role: user.role, description: '' })
...
router.post('/login',
    ...
    async (req, res) => {
        ...
        try {
            ...
            res.json({ token, name: user.name, email: user.email, userId: user.id, telephone: user.telephone, role: user.role, description: user.description })
...
router.get('/check', async (req, res) => {
    ...
    try {
        ...
        res.json({ name: user.name, email: user.email, userId: user.id, telephone: user.telephone, role: user.role, description: user.description })
    } catch (e) {
        res.status(500).json({ message: "Error" })
    }
})
